...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001607543163').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://buy64019:simransh08@cluster0.yhb94vb.mongodb.net/?retryWrites=true&w=majority")
